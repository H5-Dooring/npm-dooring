...
import { serverUrl, unParams, uuid } from '@/utils/tool';
...
class PicturesWall extends React.Component<PicturesWallType> {
  ...
  render() {
    ...
    const {
      action = `${serverUrl}/api/v0/files/upload/free`,
      headers,
    ...
    // sdk相关
    const sdk_upload_api = window.sdkOpt && window.sdkOpt.isOpen && window.sdkOpt.uploadApi
