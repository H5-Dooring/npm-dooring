...
import InteractionData from './FormComponents/InteractionData';
            ...
            {item.type === 'Pos' && (
              <Form.Item label={item.name} name={item.key}>
                <>
                  ...
                  {
                    item.placeObj && 
                    <div style={{marginTop: 10, fontSize: 12}}><a href={item.placeObj.link} target="_blank">{ item.placeObj.text }</a></div>
                  }
